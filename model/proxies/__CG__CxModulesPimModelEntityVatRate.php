 ...
 */
class VatRate extends \Cx\Modules\Pim\Model\Entity\VatRate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'rate', 'vatClass', 'products', 'validators', 'virtual', 'stringRepresentationFields', 'stringRepresentationFormat');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VatRate $proxy) {
    ...
    public function setVatClass($vatClass)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setVatClass', array($vatClass));
    ...
    public function getVatClass()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVatClass', array());
