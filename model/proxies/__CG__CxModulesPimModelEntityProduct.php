...
class Product extends \Cx\Modules\Pim\Model\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getPaymentAmount($unit = 'month', $quantifier = 1, $currency = NULL, $withVat = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPaymentAmount', array($unit, $quantifier, $currency, $withVat));
    ...
    public function getAmountWithVat($productPrice)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAmountWithVat', array($productPrice));
