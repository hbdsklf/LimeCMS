...
$_ARRAYLANG['TXT_STARTDATE'] = "Start";
$_ARRAYLANG['TXT_ENDDATE'] = "End";
...
$_ARRAYLANG['TXT_ADD_NEW_CATEGORY'] = "Eine neue Rubrik hinzufügen";
$_ARRAYLANG['TXT_NEWS_NEW_CATEGORY'] = "Neue Rubrik";
$_ARRAYLANG['TXT_NAME'] = "Name";
$_ARRAYLANG['TXT_ADD'] = "Hinzufügen";
$_ARRAYLANG['TXT_CATEGORY_LIST'] = "Rubrikliste";
...
$_ARRAYLANG['TXT_USE_TEASERS'] = "News Container verwenden";
$_ARRAYLANG['TXT_HEADLINES'] = "Headlines";
$_ARRAYLANG['TXT_TOPNEWS'] = "Top News";
$_ARRAYLANG['TXT_TEASERS'] = "News Containers";
$_ARRAYLANG['TXT_USAGE'] = "Verwendung";
$_ARRAYLANG['TXT_USE_ONLY_TEASER_TEXT'] = "Nur News Container verwenden (Newsmeldung wird nicht in den Headlines angezeigt)";
$_ARRAYLANG['TXT_TEASER_TEASER_BOXES'] = "News Container";
$_ARRAYLANG['TXT_AVAILABLE_BOXES'] = "Vorhandene Container";
$_ARRAYLANG['TXT_ASSOCIATED_BOXES'] = "Zugeordnete Container";
$_ARRAYLANG['TXT_SHORT_TEXT'] = "News Container Text";
$_ARRAYLANG['TXT_BROWSE'] = "Durchsuchen";
$_ARRAYLANG['TXT_PLACEHOLDER_DIRECTORY'] = "Platzhalter Verzeichnis";
$_ARRAYLANG['TXT_BOX_NAME'] = "Container Name";
$_ARRAYLANG['TXT_PLACEHOLDER'] = "Platzhalter";
$_ARRAYLANG['TXT_BOX_TEMPLATE'] = "Container Vorlage";
$_ARRAYLANG['TXT_FUNCTIONS'] = "Funktionen";
$_ARRAYLANG['TXT_SHOW_TEASER_BOX'] = "News Container anzeigen";
$_ARRAYLANG['TXT_EDIT_TEASER_BOX'] = "News Container bearbeiten";
$_ARRAYLANG['TXT_EDIT_BOX_TEMPLATE'] = "Container Vorlage bearbeiten";
$_ARRAYLANG['TXT_DELETE_TEASER_BOX'] = "News Container löschen";
$_ARRAYLANG['TXT_ADD_BOX'] = "Neuen Container hinzufügen";
$_ARRAYLANG['TXT_CONFIRM_DELETE_TEASER_BOX'] = "Möchten Sie diesen News Container wirklich löschen?";
$_ARRAYLANG['TXT_TEASER_BOX_TEMPLATES'] = "News Container Vorlagen";
$_ARRAYLANG['TXT_ADD_TEASER_BOX'] = "News Container hinzufügen";
...
$_ARRAYLANG['TXT_NEWS_PLACEHOLDERS_USAGE_TEXT'] = "Die folgenden Platzhalter stehen bei den Seiten zur Verfügung, welche zur <b>section</b> news gehören.";
$_ARRAYLANG['TXT_LANGUAGE_AVRIABLES'] = "Sprachvariablen";
$_ARRAYLANG['TXT_GENERAL'] = "Allgemein";
$_ARRAYLANG['TXT_NEWS_PAGIN_DESCRIPTION'] = "Navigation vom Pagingsystem";
$_ARRAYLANG['TXT_NEWS_NO_CATEGORY_DESCRIPTION'] = "Menu Option \"Rubrik\"";
$_ARRAYLANG['TXT_NEWS_CAT_DROPDOWNMENU_DESCRIPTION'] = "Rubrik Menu Optionen";
...
$_ARRAYLANG['TXT_NEWS_CATEGORY_DESCRIPTION'] = "Rubrik der Newsmeldung";
...
$_ARRAYLANG['TXT_HEADLINE_PLACEHOLDERS_USAGE'] = "In der Designvorlage <b>headlines.html</b>. Diese Seite kann mit dem Platzhalter [[HEADLINES_FILE]] im Design oder in einer Content Seite eingebunden werden.";
...
$_ARRAYLANG['TXT_TEXT_DESCRIPTION'] = "Kurzer Text der Newsmeldung";
$_ARRAYLANG['TXT_TEASER_PLACEHOLLDERS_USAGE'] = "Die News Container können im Design oder im Content eingebunden werden.<br />Verwenden Sie die Platzhalter die bei der News Container Administration angezeigt werden,<br />um die Boxen einzubinden.";
$_ARRAYLANG['TXT_TEASER_ROW_DESCRIPTION'] = "Block zur Definierung eines News Containers. Starttag: <!-- BEGIN teaser_n --> Endtag: <!-- END teaser_n -->. n ist die Box Nummer, beginnend bei 1";
...
$_ARRAYLANG['TXT_NEWS_IMAGE_DESCRIPTION'] = "Bild (News Container)";
$_ARRAYLANG['TXT_NEWS_GENERAL'] = "Allgemein";
$_ARRAYLANG['TXT_NEWS_ADVANCED'] = "Erweitert";
$_ARRAYLANG['TXT_NEWS_REDIRECT'] = "Soll eine externe Newsmeldung eingelesen werden, muss hier die entsprechende URL eingetragen werden. Beim Aufruf der Newsmeldung wird dann automatisch auf die externe Quelle verwiesen.";
$_ARRAYLANG['TXT_NEWS_REDIRECT_TITLE'] = "Weiterleitung";
$_ARRAYLANG['TXT_NEWS_MESSAGE_TYPE'] = "Meldungstyp";
...
$_ARRAYLANG['TXT_NEWS_TEASER_TEXT'] = "News Container Text";
...
$_ARRAYLANG['TXT_NEWS_ID_DESCRIPTION'] = "ID der Newsmeldung";
...
$_ARRAYLANG['TXT_NEWS_MESSAGE_PROTECTION_RESTRICTED'] = "Schützt ein Benutzer eine Newsmeldung, so kann er nur den Mitgliedern seiner Gruppen den Zugriff darauf erlauben.";
...
$_ARRAYLANG['TXT_NEWS_TEASER_TEXT_DESCRIPTION'] = "News Container Text der Newsmeldung";
$_ARRAYLANG['TXT_NEWS_CATEGORY_NAME_DESCRIPTION'] = "Name der zugehörigen Rubrik";
...
$_ARRAYLANG['TXT_NEWS_SETTINGS_COMMENTS_ALLOW_HELP'] = "Aktivieren Sie diese Option, wenn Sie Ihren Besuchern die Möglichkeit zum Kommentieren der veröffentlichten Newsmeldungen anbieten möchten.";
$_ARRAYLANG['TXT_NEWS_SETTINGS_COMMENTS_ALLOW_ANONYMOUS'] = "Anonyme Besuchern erlauben Kommentare zu erfassen";
$_ARRAYLANG['TXT_NEWS_SETTINGS_COMMENTS_ALLOW_ANONYMOUS_HELP'] = "Durch Aktivierung diser Option steht das Kommentieren von Newsmeldungen auch nicht registrierten Besuchern zur Verfügung.";
$_ARRAYLANG['TXT_NEWS_SETTINGS_COMMENTS_AUTO_ACTIVATE'] = "Automatische Aktivierung von Kommentaren";
$_ARRAYLANG['TXT_NEWS_SETTINGS_COMMENTS_AUTO_ACTIVATE_HELP'] = "Durch Aktivierung dieser Option, werden neu erfasste Kommentare automatisch auf der Website veröffentlicht.<br />Deaktivieren Sie diese Option, wenn Sie jeden Kommentar vor dessen Veröffentlichung prüfen möchten.";
$_ARRAYLANG['TXT_NEWS_SETTINGS_COMMENTS_NOTIFICATION'] = "E-Mail Benachrichtigung";
...
$_ARRAYLANG['TXT_NEWS_SETTINGS_COMMENTS_TIMEOUT_HELP'] = "Definieren Sie die Zeitspanne (in Sekunden), welche nach dem Erfassen eines Kommentars vergehen muss, bevor ein weiterer Kommentar erfasst werden darf.";
...
$_ARRAYLANG['TXT_NEWS_AUTHOR_DESCRIPTION'] = "Vor- und Nachname des Autors";
$_ARRAYLANG['TXT_NEWS_CATEGORY_ADD_ERROR_EMPTY'] = "Rubrik konnte nicht hinzugefügt werden, es wurde kein Name angegeben.";
$_ARRAYLANG['TXT_NEWS_TEASER_BOX_ADDED'] = "News Container hinzugefügt.";
$_ARRAYLANG['TXT_NEWS_TEASER_BOX_UPDATED'] = "News Container aktualisiert.";
$_ARRAYLANG['TXT_NEWS_NOTICE_NOTHING_SELECTED'] = "Kein Eintrag ausgewählt, nichts verändert.";
$_ARRAYLANG['TXT_NEWS_COPY'] = "Kopieren";
$_ARRAYLANG['TXT_REPUBLISHING'] = "Republishing";
$_ARRAYLANG['TXT_TYPES_MANAGER'] = "Typen";
$_ARRAYLANG['TXT_ADD_NEW_TYPE'] = "Einen neuen Typ hinzufügen";
$_ARRAYLANG['TXT_TYPE_LIST'] = "Typenliste";
$_ARRAYLANG['TXT_NEWS_TYPE'] = "Typ";
$_ARRAYLANG['TXT_TYPE_NOT_DELETED_BECAUSE_IN_USE'] = "Der Typ konnte nicht gelöscht werden! Bitte löschen Sie zuerst alle Untertypen.";
$_ARRAYLANG['TXT_NEWS_NO_TYPE_DESCRIPTION'] = "Menu Option \"Typ\"";
$_ARRAYLANG['TXT_NEWS_TYPE_DROPDOWNMENU_DESCRIPTION'] = "Typ Menu Optionen";
$_ARRAYLANG['TXT_NEWS_TYPE_DESCRIPTION'] = "Typ der Newsmeldung";
...
$_ARRAYLANG['TXT_NEWS_TOP_LABEL'] = "Statistische Erfassung der am häufigsten gelesenen Newsmeldungen";
$_ARRAYLANG['TXT_NEWS_TOP_DAYS'] = "Zeitrahmen [Tage]";
$_ARRAYLANG['TXT_NEWS_TOP_LIMIT'] = "Anzahl Top News";
$_ARRAYLANG['TXT_LANGUAGE'] = "Sprache";
$_ARRAYLANG['TXT_NEWS_AUTHOR'] = "Autor";
$_ARRAYLANG['TXT_NEWS_PUBLISHER'] = "Herausgeber";
$_ARRAYLANG['TXT_NEWS_AUTHOR_SELECTION'] = "Autor Auswahl";
$_ARRAYLANG['TXT_NEWS_PUBLISHER_SELECTION'] = "Publisher Auswahl";
$_ARRAYLANG['TXT_NEWS_LIST_ALL'] = "Liste aller verfügbaren Benutzerkonten";
$_ARRAYLANG['TXT_NEWS_LIST_SELECTED'] = "Nur Liste von Benutzerkonten einer ausgewählten Benutzergruppe";
$_ARRAYLANG['TXT_NEWS_AVAILABLE_GROUPS'] = "Verfügbare Benutzergruppen";
$_ARRAYLANG['TXT_NEWS_ASSIGNED_GROUPS'] = "Ausgewählte Benutzergruppen";
$_ARRAYLANG['TXT_NEWS_ALLOW_COMMENTS'] = "Kommentare erlauben";
$_ARRAYLANG['TXT_SCHEDULED_PUBLICATION'] = "Zeitgesteuerte Veröffentlichung";
...
$_ARRAYLANG['TXT_NEWS_CATEGORIES'] = "Kategorien";
$_ARRAYLANG['TXT_NEWS_CATEGORIES_PLACEHOLDERS_USAGE'] = "Das News Archiv kann mit dem folgenden <strong>[[NEWS_ARCHIVES]]</strong> angezeigt werden. <br /> Der Platzhalter kann in der Design-Vorlage oder in der Inhaltsseite verwendet werden. <br /> Dies wird ein verschachtelte ul/li-Liste aller Archive als Links auflisten.";
$_ARRAYLANG['TXT_NEWS_ARCHIVE_LIST'] = "Archivliste";
$_ARRAYLANG['TXT_NEWS_ARCHIVE_LIST_PLACEHOLDERS_USAGE'] = "Das News Archiv kann mit dem folgenden <strong>[[NEWS_ARCHIVES]]</strong> angezeigt werden. <br /> Der Platzhalter kann in der Design-Vorlage oder in der Inhaltsseite verwendet werden. <br /> Dies wird ein verschachtelte ul/li-Liste aller Archive als Links auflisten.";
$_ARRAYLANG['TXT_NEWS_RECENT_COMMENTS'] = "Neueste Kommentare";
$_ARRAYLANG['TXT_NEWS_RECENT_COMMENTS_PLACEHOLDERS_USAGE'] = "Die neuesten Kommentare können mit dem dem Platzhalter [[NEWS_RECENT_COMMENTS_FILE]] integriert werden. <br />Es benötigt die <strong>news_recent_comments.html</strong> Datei in der Design-Vorlage.";
$_ARRAYLANG['TXT_NEWS_COMMENTS_CSS_DESCRIPTION'] = "Zeilenstil (row1 oder row2)";
$_ARRAYLANG['TXT_NEWS_COMMENTS_TITLE_DESCRIPTION'] = "Kommentar Titel";
$_ARRAYLANG['TXT_NEWS_COMMENTS_MESSAGE_DESCRIPTION'] = "Kommentar Text";
$_ARRAYLANG['TXT_NEWS_COMMENTS_LONG_DATE_DESCRIPTION'] = "Kommentar Datum mit Zeit";
$_ARRAYLANG['TXT_NEWS_COMMENTS_DATE_DESCRIPTION'] = "Kommentar Datum";
...
$_ARRAYLANG['TXT_NEWS_NO_CATEGORY'] = "Weisen Sie der Meldung eine Rubrik zu.";
...
$_ARRAYLANG['TXT_NEWS_SETTINGS_USE_RELATED_NEWS'] = 'Verwandte Artikel verwenden';
